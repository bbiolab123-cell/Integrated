...
REQUIRED_SNIPPETS = {
    ...
    "PUBLIC_ITERATION10_SCRIPT_SHA256",
    "da3b2bc5129b49e75cbc18ec7ef44c851e0a986eed5780d3dacb956698f5e210",
    "c6ff42f670bba52c14ab1c35da125a8e1c2350b31add0edb3bc16b612a5436bf",
    "Counter({'train': 1240, 'validation': 20, 'test': 20})",
    "Counter({'train': 335, 'validation': 5, 'test': 5})",
    "iteration10_focused_contract_extra",
    ...
    "checkpoints-fp16-restart-safe-v7",
    "eval_strategy='no'",
