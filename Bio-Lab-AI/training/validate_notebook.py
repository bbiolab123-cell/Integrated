...
REQUIRED_SNIPPETS = {
    ...
    "PUBLIC_ITERATION8_SCRIPT_SHA256",
    "99a8f8e142ef5d7882b4ed3d9b50761e6bc04cb760c69d3678245d69ffcd5557",
    "7a19335f825bbe93f7ebdccba9996044a73743b0a4ea636245501a171bf56072",
    "Counter({'train': 880, 'validation': 20, 'test': 20})",
    "Counter({'train': 212, 'validation': 5, 'test': 5})",
    "iteration8_focused_contract_extra",
    ...
    "checkpoints-fp16-restart-safe-v5",
    "eval_strategy='no'",
