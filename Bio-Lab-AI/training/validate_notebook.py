...
REQUIRED_SNIPPETS = {
    ...
    "PUBLIC_ITERATION7_SCRIPT_SHA256",
    "0d6f803b54015b5c6702644cd8a1caab64f495fbb8ee8ef21457db477ba38861",
    "7d6425abed89fd5097f70315020158f5fff5b8eb7e2c5c9f54db8e0d09dbc0e4",
    "Counter({'train': 760, 'validation': 20, 'test': 20})",
    "Counter({'train': 172, 'validation': 5, 'test': 5})",
    "iteration7_focused_contract_extra",
    ...
    "checkpoints-fp16-restart-safe-v4",
    "eval_strategy='no'",
