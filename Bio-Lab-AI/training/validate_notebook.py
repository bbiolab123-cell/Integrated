...
PINNED_LOCAL_SCRIPTS = (
    ...
    "build_public_bootstrap_iteration5.py",
    "build_public_bootstrap_iteration6.py",
    "build_public_bootstrap_iteration7.py",
    "build_public_bootstrap_iteration8.py",
    "build_public_bootstrap_iteration9.py",
    "build_public_bootstrap_iteration10.py",
    "build_public_bootstrap_iteration11.py",
)
REQUIRED_SNIPPETS = {
    ...
    "PUBLIC_ITERATION11_SCRIPT_SHA256",
    "9521647bcfd9803fd5bdd54ca1d2cfce8a08bd19fd3c5610f3d7147fad33a16b",
    "cdce3114a0c963510305da2c5c435c30295562adf7803c46c3dfbda79baef3c6",
    "Counter({'train': 1480, 'validation': 20, 'test': 20})",
    "Counter({'train': 410, 'validation': 5, 'test': 5})",
    "iteration11_focused_contract_extra",
    ...
    "checkpoints-fp16-restart-safe-v8",
    "eval_strategy='no'",
